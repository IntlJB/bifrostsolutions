...
- [ ] **Step 1: Write failing tests for the apex-domain contract**
...
- [ ] **Step 2: Write failing tests for new routes and navigation**
...
- [ ] **Step 3: Normalize page metadata and schema**
...
- [ ] **Step 2: Create the reusable marketing page**
...
- [ ] **Step 3: Replace the home-local header**
...
- [ ] **Step 1: Add small-business route**
...
- [ ] **Step 3: Add hosting-and-operation route**
...
- [ ] **Step 4: Verify GREEN for landing routes**
...
- [ ] **Step 2: Convert screenshots and existing imagery**
...
- [ ] **Step 4: Verify asset size and references**
...
- [ ] **Step 1: Build accessible preview switching**
...
- [ ] **Step 2: Build the shared case-detail component**
...
- [ ] **Step 5: Run design pre-flight scans**
...
- [ ] **Step 3: Verify GSC access and sitemap configuration**
